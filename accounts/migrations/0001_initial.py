...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding model 'AuthTeacher'
        db.create_table('accounts_authteacher', (
        ...
        db.send_create_signal('accounts', ['AuthTeacher'])

        # Adding model 'AuthStudent'
    ...
    def backwards(self, orm):
        ...
        # Deleting model 'AuthTeacher'
        db.delete_table('accounts_authteacher')

        # Deleting model 'AuthStudent'
        db.delete_table('accounts_authstudent')
