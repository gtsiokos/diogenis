...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding field 'Lab.start_hour'
        db.add_column('labs_lab', 'start_hour', self.gf('django.db.models.fields.IntegerField')(default=101, max_length=2), keep_default=False)

        # Adding field 'Lab.end_hour'
        db.add_column('labs_lab', 'end_hour', self.gf('django.db.models.fields.IntegerField')(default=102, max_length=2), keep_default=False)


    def backwards(self, orm):
        
        # Adding field 'Lab.hour'
        db.add_column('labs_lab', 'hour', self.gf('django.db.models.fields.IntegerField')(default=100, max_length=2), keep_default=False)

        # Deleting field 'Lab.start_hour'
        db.delete_column('labs_lab', 'start_hour')

        # Deleting field 'Lab.end_hour'
        db.delete_column('labs_lab', 'end_hour')
    ...
    models = {
        ...
        'labs.lab': {
            'Meta': {'ordering': "['name', 'day', 'start_hour', 'end_hour']", 'object_name': 'Lab'},
