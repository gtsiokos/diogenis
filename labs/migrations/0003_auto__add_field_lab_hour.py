...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.add_column('labs_lab', 'hour', self.gf('django.db.models.fields.IntegerField')(default=2, max_length=2), keep_default=False)
    ...
    models = {
        ...
        'labs.lab': {
            'Meta': {'ordering': "['name', 'day', 'hour', 'start_hour']", 'object_name': 'Lab'},
