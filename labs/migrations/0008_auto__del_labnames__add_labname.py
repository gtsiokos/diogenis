...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Deleting model 'LabNames'
        db.delete_table('labs_labnames')

        # Adding model 'LabName'
        db.create_table('labs_labname', (
            ('id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('name', self.gf('django.db.models.fields.CharField')(max_length=20)),
        ))
        db.send_create_signal('labs', ['LabName'])


    def backwards(self, orm):
        
        # Adding model 'LabNames'
        db.create_table('labs_labnames', (
            ('id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('name', self.gf('django.db.models.fields.CharField')(max_length=20)),
        ))
        db.send_create_signal('labs', ['LabNames'])

        # Deleting model 'LabName'
        db.delete_table('labs_labname')
    ...
    models = {
        ...
        'labs.labname': {
            'Meta': {'ordering': "['name']", 'object_name': 'LabName'},
            'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'name': ('django.db.models.fields.CharField', [], {'max_length': '20'})
        },
        'labs.lesson': {
