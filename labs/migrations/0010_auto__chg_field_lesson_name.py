...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.alter_column('labs_lesson', 'name', self.gf('django.db.models.fields.CharField')(max_length=100))


    def backwards(self, orm):
        
        # Changing field 'Lesson.name'
        db.alter_column('labs_lesson', 'name', self.gf('django.db.models.fields.CharField')(max_length=40))
